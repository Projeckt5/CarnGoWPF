...
namespace CarnGo.Database
{
    public class DebugAppDbContext : AppDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server = tcp:carngoserver.database.windows.net, 1433; Initial Catalog = CarnGoDb; Persist Security Info = False; User ID = CarnGo; Password = Admin123; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;");
            }
        }
    }
